...
assert_type(value_generator.front_normal(), Direction)
assert_type(value_generator.center_normal(), Direction)
assert_type(value_generator.back_normal(), Direction)
